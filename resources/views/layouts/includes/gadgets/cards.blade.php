<div class="row mt-3 text-aligned BKoodakBold">
    ...
    <div class="col-sm-6 col-lg-3">
        <a href="{{ route('panel.contacts.all') }}"><div class="card text-white bg-dracula mb-3" style="max-width: 18rem;">
            <div class="card-header d-flex justify-content-between align-items-center"><span><i class="fas fa-users"></i></span>  <span class="badge badge-pill right">84</span></div>
            <div class="card-body">
